...
public class CalendarificComObtainerTests {
    ...
    @Test
    public void holidayInfoShouldBeReturnedForExistingHolidays() {
        int year = 2012;
    ...
    @Test
    public void nullShouldBeReturnedForNonExistingHolidays() {
        int year = 2012;
        String countryCode = "PL";
        String expectedUrl = String.format("%s?country=%s&year=%d&api_key=%s", BASE_URL, countryCode, year, API_KEY);
    ...
    private CalendarificComApiResponse getPrebuiltBasicApiResponse(LocalDate date, String name) {
